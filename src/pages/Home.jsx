...
import { getAllCategory, getAllCourses, myCourse } from "../Redux/slices/courseSlice";
  ...
  return (
    <Layout>
      <div>
        ...
        >
          ...
          <div className="relative h-full flex flex-col items-center justify-center text-white  ">
            <div className="space-y-4 flex flex-col justify-center items-center  w-[80vw]">
              ...
              {<Link to={'/contact'}>  <div className="relative z-10 bg-purple-500 rounded-md">
                  <button
        ...
        {/* chat */}
      {import.meta.env.VITE_REACT_APP_CHATING === 'true' &&  <div className="fixed z-50 bottom-10 right-8 bg-purple-400 rounded-[50%] w-14 h-14 flex justify-center items-center">
          <div className="">
